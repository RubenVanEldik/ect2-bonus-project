...
cf_explanation = "The capacity factor for wind en solar PV has been calculated by dividing the sum of the output by their respective capacity and total number of hours (8760) per year."
